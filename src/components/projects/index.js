...
import { getProjects, searchProjects, sortProjectsASC, sortProjectsDESC } from "../../actions/projectsAction";
...
class Projects extends Component {
  ...
  handleClick = () => {
    ...
    this.state.isToggleOn ? this.sortByProjectIdASC() : this.sortByProjectIdDESC();
  };
  //Sort by Ascending
  sortByProjectIdASC = () => {
    ...
    return (
      <div className="projects-container">
        <div className="top-navigation-bar">
          ...
          <form>
            <input type="text" onChange={this.searchHandler} placeholder="Search by description..." />
          </form>
          <button onClick={this.handleClick}>{this.state.isToggleOn ? "SORTBYIDASC>>>" : "SORTBYIDDESC<<<"}</button>
        </div>
        <table>
          <thead>
            <tr>
